...
namespace Fragsurf.Movement {
    public class SurfController {
            ...
            switch (_surfer.moveType) {
                ...
                if (_surfer.groundObject == null) {
                    ...
                    */
                    ...
                    if ((_surfer.moveData.velocity.magnitude > _config.minimumSlideSpeed || onSlope ) && _surfer.moveData.slidingEnabled && _surfer.moveData.crouching && _surfer.moveData.slideDelay <= 0f) {
        ...
        public void Crouch (ISurfControllable surfer, MovementConfig config, float deltaTime) {
            ...
            if (!_surfer.moveData.crouching)
                _surfer.moveData.viewTransform.localPosition = Vector3.Lerp (_surfer.moveData.viewTransformDefaultLocalPos, _surfer.moveData.viewTransformDefaultLocalPos * crouchingHeight + Vector3.down * heightDifference * 0.5f, _surfer.moveData.crouchLerp);
            else
                _surfer.moveData.viewTransform.localPosition = Vector3.Lerp (_surfer.moveData.viewTransformDefaultLocalPos - Vector3.down * heightDifference * 0.5f, _surfer.moveData.viewTransformDefaultLocalPos * crouchingHeight, _surfer.moveData.crouchLerp);
